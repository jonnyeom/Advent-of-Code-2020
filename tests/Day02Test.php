...
use UnleashedTech\AdventOfCode2020\Day02;

/**
 * @coversDefaultClass \UnleashedTech\AdventOfCode2020\Day02
 */
final class Day02Test extends TestCase {

    /**
     * @covers ::getNumberOfValidPasswords
     */
    public function testGetNumberOfValidPasswords(): void {
        $solution = new Day02();

        self::assertSame(2, $solution->getNumberOfValidPasswords($this->passwords1));
